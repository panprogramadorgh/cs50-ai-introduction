...
Por cada leccion encontraremos una carpeta diferente prefijada con `week-` y dentro a su vez, el documento correspondiente al contenido del curso. El fichero de cada leccion se encontrara dentro de las carpetas siempre tiene como nombre "**_notes.md_**".
